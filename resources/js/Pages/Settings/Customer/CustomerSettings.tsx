...
import { Cog6ToothIcon, UserIcon, BellIcon, LockClosedIcon } from '@heroicons/react/24/outline';
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-5">
          ...
          <div className="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
            <div className="shadow sm:overflow-hidden sm:rounded-lg">
              <div className="space-y-6 bg-white py-6 px-4 sm:p-6 dark:bg-gray-800">
                <div>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-6">
                  <div className="sm:col-span-4">
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        defaultValue={auth.user.name.toLowerCase().replace(/\s+/g, '')}
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        name="about"
                        rows={3}
                        className="block w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                        defaultValue={''}
                      />
                    </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <div className="mt-1 flex items-center">
                      <span className="inline-block h-12 w-12 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-600">
                      ...
                      <button
                        type="button"
                        className="ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:bg-gray-600"
                      >
                        Change
                      </button>
                    </div>
                    ...
                    <div className="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6 dark:border-gray-600">
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600 dark:text-gray-400">
                          <label
                            htmlFor="file-upload"
                            className="relative cursor-pointer rounded-md bg-white font-medium text-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2 hover:text-blue-500 dark:bg-gray-800 dark:text-blue-400 dark:hover:text-blue-300"
                          >
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                          Get notified when payments are completed or failed.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                          Get notified when weather conditions affect scheduled payments.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start">
                ...
                <fieldset className="mt-6">
                  ...
                  <div className="mt-4 space-y-4">
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="push-everything" className="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Everything
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
                      />
                      <label htmlFor="push-email" className="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Same as email
                      </label>
                    </div>
                    <div className="flex items-center">
                      <input
                        ...
                        className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
                      />
                      <label htmlFor="push-nothing" className="ml-3 block text-sm font-medium text-gray-700 dark:text-gray-300">
